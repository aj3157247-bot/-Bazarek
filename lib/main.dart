              ...
              onPressed: uploading
                  ...
                  : () {
                      ...
                      if (imageBytes.isNotEmpty && imageUrls.isEmpty) {
                        _msg(Exception('ابتدا عکس‌ها را آپلود کنید.'));
                        return;
                      }
